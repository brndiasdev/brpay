    ...
    >
      <div className="relative mx-auto max-w-6xl px-4 md:px-8 py-16 md:py-24">
        ...
        >
          ...
          <div>
            <motion.div  className="inline-flex items-center gap-2 rounded-full border px-3 py-1 text-xs md:text-sm"
              style={{
            ...
            <motion.p
              ...
              className="mt-3 text-base md:text-lg opacity-90 max-w-prose"
            >
              Plataforma de pagamentos com foco em conversão: PIX D+0, cartão com roteamento
              inteligente e conciliação simples — tudo em um só lugar.
            </motion.p>
            ...
            <motion.div  className="mt-8 flex flex-col sm:flex-row gap-3">
              ...
              <Link
                ...
                style={{
                  ...
                  borderColor: 'var(--cta-secondary-border, rgba(255,255,255,0.25))',
            ...
            >
              ...
              <li className="flex items-center gap-2 rounded-lg border px-3 py-2"
                  style={{ borderColor: 'var(--cta-chip-border, rgba(255,255,255,0.14))',
                           background: 'var(--cta-chip-bg, rgba(255,255,255,0.06))' }}>
                <CreditCard className="h-4 w-4" aria-hidden /> Alta aprovação no cartão
              </li>
              <li className="flex items-center gap-2 rounded-lg border px-3 py-2"
                  style={{ borderColor: 'var(--cta-chip-border, rgba(255,255,255,0.14))',
                           background: 'var(--cta-chip-bg, rgba(255,255,255,0.06))' }}>
              ...
              <li className="flex items-center gap-2 rounded-lg border px-3 py-2"
                  style={{ borderColor: 'var(--cta-chip-border, rgba(255,255,255,0.14))',
                           background: 'var(--cta-chip-bg, rgba(255,255,255,0.06))' }}>
                <ShieldCheck className="h-4 w-4" aria-hidden /> Segurança nível bancário
              </li>
            </motion.ul>
          </div>
          ...
          <motion.div >
            ...
            >
              <div className="flex items-center gap-3">
                <div className="h-9 w-9 rounded-lg grid place-items-center border"
                     style={{ borderColor: 'var(--cta-card-border, rgba(255,255,255,0.15))',
                              background: 'rgba(255,255,255,0.06)' }}>
                  <Zap className="h-5 w-5" aria-hidden />
                </div>
                <div>
                  <p className="text-sm opacity-80">Tempo médio de liquidação PIX</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="rounded-lg border p-4 col-span-2"
                  ...
                  <p className="mt-1 font-medium">Shopify, WooCommerce, WordPress e API própria</p>
                </div>
              </div>
